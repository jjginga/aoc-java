...
public class Constants {
    ...
    public static final String DAY_03 = "day03";
    public static final String DAY_04 = "day04";
    public static final String DAY_05 = "day05";
    public static final String DAY_06 = "day06";
    public static final String DAY_07 = "day07";
    public static final String DAY_08 = "day08";
    public static final String DAY_09 = "day09";
    ...
    public static final String PART_1 = "_1";
    public static final String PART_2 = "_2";
