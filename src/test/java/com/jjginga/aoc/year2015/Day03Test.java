...
public class Day03Test {
    ...
    void testPart1() throws IOException {
        ...
        System.out.printf("%s %s -> Part 1, result: %s | took %.2f ms%n", YEAR_2015, DAY_03, result, duration / 1_000_000.0);
    ...
    void testPart2() throws IOException {
        ...
        long duration = System.nanoTime() - start;
        System.out.printf("%s %s -> Part 2, result: %s | took %.2f ms%n", YEAR_2015, DAY_03, result, duration / 1_000_000.0);
